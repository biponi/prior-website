        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20 relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4">
              Contact{" "}
              <span className="text-babybloom-pink">Us</span>
            </h1>
            <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto">
              Have a question, suggestion, or need help with an order? We&apos;re
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-3">
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 md:p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1.5">
                      Your Message <span className="text-babybloom-pink">*</span>
                    </label>
                    <Textarea
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-gradient-to-br from-babybloom-pink/5 to-pink-50/50 rounded-2xl p-6 border border-babybloom-pink/10">
                ...
                <div className="mt-4 pt-4 border-t border-babybloom-pink/10">
                  <p className="text-xs text-gray-500">
                    * Closed on public holidays. Hours are in Bangladesh Standard
                    Time (BST).
                  </p>
                </div>
              </div>
              ...
              <div className="rounded-2xl overflow-hidden border border-gray-100 shadow-sm">
                <iframe
                  src={`https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3651.7721996343375!2d${brandConfig.contact.address.coordinates.lng}!3d${brandConfig.contact.address.coordinates.lat}!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755bf536d1cf7bb%3A0x9ba1b02f4265d430!2sUttara%20Square%20Shopping%20Mall!5e0!3m2!1sen!2sbd!4v1726519259387!5m2!1sen!2sbd`}
                  width="100%"
                  height="250"
